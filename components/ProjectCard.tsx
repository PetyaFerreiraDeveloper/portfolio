        ...
        return (
            <div>
                <Image
                    ...
                    layout='responsive'
                />
                {/* <img src={image_path} alt={name} className="cursor-pointer h-30" onClick={() =>
                    setShowDetail(true)} /> */}
                    ...
                    <div className="absolute top-0 left-0 z-10 grid w-full h-auto p-2 text-black bg-gray-100 rounded-lg md:grid-cols-2 gap-x-12 dark:text-white dark:bg-dark-100 md:p-10">
                        ...
                        >
                            ...
                            className="flex justify-center my-4 space-x-3">
                                <a href={github_url} className="flex items-center px-4 py-2 space-x-3 bg-gray-200 dark:bg-dark-200">
                                    <AiFillGithub /> <span>Github</span>
                                </a>
                                <a href={deployed_url} className="flex items-center px-4 py-2 space-x-3 bg-gray-200 dark:bg-dark-200">
