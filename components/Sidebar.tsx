...
const Sidebar = () => {
    return (
        <div>
            ...
            <a
                href=""
                className="flex items-center justify-center px-2 py-1 my-3 space-x-2 bg-gray-200 rounded-full"
                download='name'>
            ...
            {/* // address */}
            <div 
                className="py-4 my-5 bg-gray-200 rounded-full"
            ...
            <button className="w-8/12 px-5 py-2 my-2 text-white rounded-full bg-gradient-to-r from-myColor to-blue-500">Toggle Theme</button>
